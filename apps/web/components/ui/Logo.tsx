...
export function Logo({
  ...
  const drawEdge = (delay: number): CSSProperties =>
    a
      ? {
          ['--len' as string]: 30,
          strokeDasharray: 30,
          animation: `drawEdge 2.6s ease ${delay}s infinite alternate both`,
        }
      : {};
  ...
  const hbRing = (delay: number): CSSProperties =>
    a
      ? {
          transformBox: 'fill-box',
          transformOrigin: 'center',
          animation: `logoHbRing 2s ease ${delay}s infinite`,
        }
      : { opacity: 0 };
  const hbPulse = (delay: number): CSSProperties =>
    a
      ? {
          transformBox: 'fill-box',
          transformOrigin: 'center',
          animation: `logoHbPulse 2s ease ${delay}s infinite`,
        }
      : {};
  ...
  const ping = (delay: number): CSSProperties =>
    a
      ? {
          transformBox: 'fill-box',
          transformOrigin: 'center',
          animation: `logoPing 2.4s ease ${delay}s infinite`,
        }
      : { opacity: 0 };
  const topGlow: CSSProperties = a
    ? {
        transformBox: 'fill-box',
        transformOrigin: 'center',
        animation: `logoTopGlow 2.4s ease infinite`,
      }
    : {};
  ...
  const hsEdge = (delay: number): CSSProperties =>
    a
      ? {
          ...
          strokeDasharray: 24,
          strokeDashoffset: 24,
          animation: `logoHsEdge 3s ease ${delay}s infinite`,
        }
      : {};
  const hsNode = (delay: number): CSSProperties =>
    a
      ? {
          transformBox: 'fill-box',
          transformOrigin: 'center',
          animation: `logoHsNode 3s ease ${delay}s infinite`,
        }
      : {};
