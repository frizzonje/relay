  ...
  return (
    <div className="flex h-[100dvh] flex-col overflow-hidden md:flex-row">
      ...
      <div className="flex min-h-0 flex-1 md:contents">
        ...
        >
          <ServerRail />
          {/* Тулбар здесь — только на мобиле: там он горизонтальная полоса НАД
              списком каналов. На десктопе его место — крайняя правая рейка (см.
              ниже, после колонки состава), и рисовать его тут значило бы держать
              на экране два тулбара разом. */}
