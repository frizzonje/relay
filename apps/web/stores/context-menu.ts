...
/**
 * Значок пункта — имя из общего набора (components/ui/icon), а не свободная
 * картинка: начинка меню остаётся обычными данными, которые можно собирать и
 * проверять без рендера. Раньше здесь стоял свой список из двенадцати имён,
 * и меню рисовало их собственными контурами — двенадцатью копиями.
 */
