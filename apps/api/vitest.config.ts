  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'src/settings/settings.testkit.ts',
        'src/db/testing.ts',
        ...
        'src/main.ts',
        'src/app.module.ts',
        // Типы сокета: объявления без единой исполняемой строки. v8 честно
        // считает такой файл нулём, и этот ноль тянет вниз цифру, по которой
        // ищут настоящие дыры.
        'src/gateway/socket-data.ts',
