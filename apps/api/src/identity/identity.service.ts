...
export type VerifyFailure =
   ...
   * (`access.identityCreation` = `closed`).
...
export class IdentityService {
  ...
  /**
   * Заводить ли новые личности. Ключ один: рядом стоял второй
   * (`blockNewIdentities`, «рубильник поверх правила»), но после того как из
   * правила исчезла третья дверь — «по приглашению», которой в relay нет, —
   * правило само стало рубильником, и два имени закрывали ровно одно и то же.
   *
