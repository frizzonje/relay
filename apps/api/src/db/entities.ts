...
export class MessageRow {
  ...
  /**
   * Подпись автора — самоназначаемый тег (audit S1). Слой 2 добавит рядом
   * `author_identity_id`, и вот тогда автор станет проверяемым; до тех пор
   * правка и удаление своего сверяются по этой строке, как и раньше.
   */
