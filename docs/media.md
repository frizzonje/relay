...
- RED в SFU нет: mediasoup не знает `audio/red`; от потерь спасает in-band FEC,
  который говорящий наращивает под худшего слушателя (см.
  [plans/voice-quality.md](plans/voice-quality.md#итог-разведки-2026-09-24)).
