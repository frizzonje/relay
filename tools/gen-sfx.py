...
SOUNDS = {
    ...
    # Пара нот погромче и покороче остальных — короткий цикл с паузой в
    # хвосте читается как «дзинь-дзинь … дзинь-дзинь», а не как звонок в дверь.
    "ring":       mix([ev(E3, 0.30, 0.00, 0.46), ev(A3, 0.30, 0.16, 0.46)],
                      tail=0.90, wet=0.22, predelay=0.008, level=0.55),
