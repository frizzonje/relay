...
export const SETTINGS: readonly SettingSpec[] = [
  ...
  // MAX_UPLOAD_BYTES = 25 МиБ. Границы — от килобайта до гигабайта: ниже
  // килобайта нельзя загрузить ничего, выше гигабайта не выдержит ни диск
  // инсталляции, ни терпение того, кто это льёт через браузер.
  {
