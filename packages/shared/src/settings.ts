...
export const SETTINGS: readonly SettingSpec[] = [
  ...
  // ЗВУКОМ входящих сигналов, это — про системное окошко поверх остальных
  // окон, когда вкладку/приложение свернули. Человек волен выключить одно, не
  // трогая другое (беззвучная вкладка — законный выбор, и его не должно чинить
  // выключение попапов, о которых речь не шла).
  {
